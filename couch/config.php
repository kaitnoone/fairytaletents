...
define('K_DB_NAME', 'fairytal_tents');
// 5.
// Database username
define('K_DB_USER', 'fairytal_dbuser');
// 6.
// Database password
define('K_DB_PASSWORD', '/J`p4]zY[7nT');
// 7.
...
define('K_DB_TABLES_PREFIX', 'fttents');
