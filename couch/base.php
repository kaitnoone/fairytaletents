...
class KBaseAdmin
{
    ...
    public $form_name = 'k_admin_frm';
    public $list_form_name = 'k_admin_frm_list';
    ...
    public function define_list_title()
    {
        global $FUNCS;
    ...
    public function define_list_actions()
    {
        global $FUNCS;
    ...
    public function define_list_fields()
    {
        global $FUNCS;
    ...
    public function _default_list_toolbar_actions()
    {
        $arr_buttons = array();
    ...
    public function _default_list_filter_actions()
    {
        $arr_filters = array();
    ...
    public function _default_list_batch_actions()
    {
        $arr_actions = array();
    ...
    public function _default_list_page_actions()
    {
        $arr_actions = array();
    ...
    public function _default_list_extended_actions()
    {
        $arr_actions = array();
    ...
    public function _default_list_row_actions()
    {
        $arr_actions = array();
    ...
    public function _default_list_fields()
    {
    ...
    public function _set_list_sort($orderby = '', $order = '')
    {
        global $FUNCS;
    ...
    public function _set_list_limit($limit = '')
    {
        global $FUNCS;
    ...
    public function define_form_title()
    {
        global $FUNCS;
    ...
    public function define_form_actions()
    {
        global $FUNCS;
    ...
    public function define_form_fields()
    {
        global $FUNCS;
    ...
    public function _default_form_toolbar_actions()
    {
        $arr_buttons = array();
    ...
    public function _default_form_filter_actions()
    {
        $arr_filters = array();
    ...
    public function _default_form_page_actions()
    {
        global $FUNCS;
        $arr_actions = array();
    ...
    public function _default_form_extended_actions()
    {
        $arr_actions = array();
    ...
    public function _setup_form_variables()
    {
        global $CTX;
    ...
    public function _default_form_fields()
    {
        $arr_default_fields = array();
    ...
    public function _set_default_field_groups(&$arr_fields)
    {
    ...
    public function _set_default_fields(&$arr_fields)
    {
        global $AUTH;
    ...
    public function _get_object_to_edit()
    {
        return;
    }

    public function _set_advanced_setting_fields(&$arr_fields)
    {
    ...
    public function _persist_form_success_handler(&$pg, $_mode)
    {
        global $CTX, $FUNCS;
    ...
    public function _get_form_redirect_link(&$pg, $_mode)
    {
        global $CTX;
