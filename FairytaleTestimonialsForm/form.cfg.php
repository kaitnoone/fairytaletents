...
"settings":
{
	"data_settings" : 
	{
		...
		"save_sqlite" : 
		{
			"database" : "Fairytale Testimonials.dat",
			"is_present" : false,
			"tablename" : "Fairytale Testimonials"
		}
	},
	"email_settings" : 
	{
	...
	"uid" : "b3f50f75f5e36ce126280853e9e15e5b",
	"validation_report" : "in_line"
},
"rules":{"to":{"label":"To","fieldtype":"text","required":true},"message":{"label":"Message","fieldtype":"textarea","maxlength":"10000","required":true},"from":{"label":"From","fieldtype":"text","required":true},"text4":{"label":"Date of Event","fieldtype":"text"}},
"payment_rules":{},
"conditional_rules":{},
